...
<template>
	<div class="d-flex flex-row align-items-center justify-content-start gap-3">
		<input class="form-check-input m-0 overflow-hidden position-relative float-none border-0" type="checkbox" role="switch" :id="id" :checked="modelValue"
			@change="$emit('update:modelValue', $event.target.checked)" :disabled="disabled" :tabindex="disabled ? -1 : 0">
